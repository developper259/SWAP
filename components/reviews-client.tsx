...
export default function ReviewsClient() {
  ...
  return (
    <div>
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-foreground mb-2">{t('reviewsPage.title')}</h1>
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-12">
          <div className="bg-card border border-border rounded-2xl p-6">
            <p className="text-sm text-muted-foreground mb-2">{t('reviewsPage.averageRating')}</p>
          ...
          <div className="bg-card border border-border rounded-2xl p-6">
            <p className="text-sm text-muted-foreground mb-2">{t('reviewsPage.totalReviews')}</p>
            <p className="text-3xl font-bold text-foreground">23</p>
          </div>

          <div className="bg-card border border-border rounded-2xl p-6">
            <p className="text-sm text-muted-foreground mb-2">{t('reviewsPage.positiveRate')}</p>
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-bold text-foreground mb-4">{t('reviewsPage.recentReviews')}</h2>
          {REVIEWS.map((review) => (
            <div
              key={review.id}
